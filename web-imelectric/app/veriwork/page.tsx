...
export const metadata: Metadata = {
  ...
  title: "Veriwork — Gestión HSE verificable para Colombia | Permisos de Trabajo Digitales | IMELECTRIC",
  description:
  ...
  keywords: [
    ...
    "trazabilidad documental HSE inalterable",
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Veriwork aplica firma Ed25519 (ligada a la empresa emisora) más sello de tiempo PAdES conforme a RFC 3161. Cada permiso incluye un QR de verificación pública que cualquier ente de control puede consultar para comprobar que el documento no ha sido alterado. Para actas de alta severidad (accidentes graves, fatalidades) el protocolo incluye refuerzo notarial. La segregación de roles garantiza que quien reporta no es quien autoriza, cumpliendo el requisito de firma electrónica con valor legal del Decreto 2364 de 2012.",
      },
    },
    {
      "@type": "Question",
      ...
      <section className="border-b border-slate-800 bg-slate-950 px-6 pt-36 pb-12">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="max-w-3xl text-base leading-relaxed text-slate-400 sm:text-lg">
            ...
            y Decreto 1072, y trazabilidad forense inalterable ante auditorías del Ministerio de Trabajo.
          </p>
